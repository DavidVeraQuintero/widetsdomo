...
export const WIDGET_CATALOG = [
  ...
  // ── CLIMA ──
  { id: 'aire-acondicionado', category: 'Clima', categoryIcon: '🌡', icon: '❄',  name: 'Aire Acondicionado', sizes: ['1x1','1x2','2x1','2x2','4x2'], defaultConfig: { on: false, name: 'AC', temp: 24, mode: 'frío' }, component: AireAcondicionado },
  ...
  { id: 'purificador',     category: 'Clima', categoryIcon: '🌡', icon: '🌬', name: 'Purificador Aire',   sizes: ['1x2','2x1','2x2'],             defaultConfig: { on: false, name: 'Purificador', aqi: 25 }, component: PurificadorAire },
  // ── SEGURIDAD ──
  ...
  // ── MULTIMEDIA ──
  { id: 'tv',              category: 'Multimedia', categoryIcon: '🎵', icon: '📺', name: 'TV',              sizes: ['1x2','2x1','2x2','2x4'], defaultConfig: { on: false, source: 'HDMI 1', volume: 30, name: 'TV' }, component: TV },
  { id: 'musica',          category: 'Multimedia', categoryIcon: '🎵', icon: '🎵', name: 'Música',          sizes: ['1x2','2x1','2x2','4x4'], defaultConfig: { playing: false, track: 'Blinding Lights', artist: 'The Weeknd', volume: 65, name: 'Música' }, component: Musica },
  ...
  // ── ESCENAS ──
  { id: 'escena-individual', category: 'Escenas', categoryIcon: '🎬', icon: '🎬', name: 'Escena',          sizes: ['1x1','1x2','2x1'],       defaultConfig: { active: false, sceneName: 'Noche', sceneIcon: '🌙', sceneColor: '#0f1f14' }, component: EscenaIndividual },
  { id: 'panel-escenas',   category: 'Escenas', categoryIcon: '🎬', icon: '🎭', name: 'Panel Escenas',    sizes: ['2x2','2x4','4x2'], defaultConfig: { activeScene: null, scenes: [{ id:'noche', name:'Noche', icon:'🌙', color:'#0f1f14' }, { id:'película', name:'Película', icon:'🎬', color:'#1e1b4b' }, { id:'lectura', name:'Lectura', icon:'📖', color:'#1c1507' }, { id:'fiesta', name:'Fiesta', icon:'🎉', color:'#1f0e1a' }] }, component: PanelEscenas },
  { id: 'escena-activa',   category: 'Escenas', categoryIcon: '🎬', icon: '▶', name: 'Escena Activa',    sizes: ['1x2','2x2'],       defaultConfig: { activeScene: 'Película', activeIcon: '🎬', activeColor: '#1e1b4b' }, component: EscenaActiva },
  // ── AUTOMATIZACIÓN ──
  { id: 'temporizador',    category: 'Automatización', categoryIcon: '🤖', icon: '⏱', name: 'Temporizador',  sizes: ['1x2','2x1','2x2'], defaultConfig: { active: false, minutes: 30, name: 'Timer' }, component: Temporizador },
  { id: 'regla-auto',      category: 'Automatización', categoryIcon: '🤖', icon: '⚙', name: 'Regla Auto',    sizes: ['1x2','2x1','2x2'], defaultConfig: { enabled: true, name: 'Si anochece → luces' }, component: ReglaAutomatica },
